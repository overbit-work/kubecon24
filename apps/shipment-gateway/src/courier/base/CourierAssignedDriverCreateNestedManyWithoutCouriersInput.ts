...
@InputType()
class CourierAssignedDriverCreateNestedManyWithoutCouriersInput {
...
export { CourierAssignedDriverCreateNestedManyWithoutCouriersInput as CourierAssignedDriverCreateNestedManyWithoutCouriersInput };
