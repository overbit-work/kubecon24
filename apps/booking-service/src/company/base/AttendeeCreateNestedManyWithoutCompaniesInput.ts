...
@InputType()
class AttendeeCreateNestedManyWithoutCompaniesInput {
...
export { AttendeeCreateNestedManyWithoutCompaniesInput as AttendeeCreateNestedManyWithoutCompaniesInput };
